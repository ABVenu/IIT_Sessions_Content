"""Upload masterclass01 Hands-On LangChain lecture note images to S3."""
import os
...
PREFIX = "iitr-as-260113/module3/masterclass01-hands-on-langchain"
...
urls = {}
for path in sorted(images_dir.glob("masterclass01-*.png")):
