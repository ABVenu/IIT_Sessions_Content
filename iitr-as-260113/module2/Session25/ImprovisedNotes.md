...
![Keyword-only retrieval matches surface words; semantic retrieval aligns query and document by meaning](https://s13n-curr-images-bucket.s3.ap-south-1.amazonaws.com/iitr-as-260113/module2/session25/session25-keyword-vs-semantic.png)
...
![From raw text to tokens, through an embedding model, to a numeric vector used for similarity](https://s13n-curr-images-bucket.s3.ap-south-1.amazonaws.com/iitr-as-260113/module2/session25/session25-text-to-vector-pipeline.png)
...
![Simplified view of embedding space: texts on similar topics cluster together; distance reflects semantic difference](https://s13n-curr-images-bucket.s3.ap-south-1.amazonaws.com/iitr-as-260113/module2/session25/session25-vector-space.png)
...
![Semantic search: embed documents and queries, compare vectors, retrieve nearest matches, use results in the application](https://s13n-curr-images-bucket.s3.ap-south-1.amazonaws.com/iitr-as-260113/module2/session25/session25-semantic-search-workflow.png)
