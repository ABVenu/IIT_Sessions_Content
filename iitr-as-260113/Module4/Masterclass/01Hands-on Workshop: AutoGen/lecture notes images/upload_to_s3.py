"""Upload AutoGen masterclass lecture note images to S3."""
import os
...
PREFIX = "iitr-as-260113/module4/masterclass/01handson-workshop-autogen"
...
urls = {}
for path in sorted(images_dir.glob("masterclass-autogen-*.png")):
