...
**Ananya** is invited in as the designer. She has just spent this module putting **campus agents** live: logging, alerts, privacy rules, and cost caps. The retail partner, **Nimbus Retail**, does not need another campus chatbot. It needs the same **desk discipline** applied to a real **invoice** line.
