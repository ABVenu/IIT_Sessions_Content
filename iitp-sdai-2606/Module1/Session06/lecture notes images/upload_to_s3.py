"""Upload session06 lecture note images to S3 and refresh links in Lecture Notes.md."""
import os
import re
...
PREFIX = "iitp-sdai-2606/module1/session06"
BASE_URL = os.environ["AWS_BUCKET_URL"].rstrip("/")
VERSION = date.today().strftime("%Y%m%d") + "-ai"
...
notes_files = [SESSION_DIR / "Lecture Notes.md"]
urls = {}
for path in sorted(images_dir.glob("session06-*.png")):
