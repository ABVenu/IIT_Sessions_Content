"""Upload Masterclass Session02 lecture note images to S3 and print URL map."""
import os
...
PREFIX = "iitp-sdai-2606/module1/masterclass/session02"
...
urls = {}
for path in sorted(images_dir.glob("masterclass02-0*.png")):
