"""Upload session14 lecture note images to S3 and refresh links in Lecture Notes.md."""
import os
import re
...
PREFIX = "iitp-sdai-2606/module2/session14"
...
urls = {}
for path in sorted(images_dir.glob("session14-0*.png")):
