...
title: Deployment: FastAPI RAG on Render

objective: Build a simple Groq RAG API with FastAPI, explain local vs deployed apps, and deploy a mini app on Render (local file or Supabase knowledge).

type of session: mixture of theory + implementation

topics be covered: why deployment; local vs deployed; FastAPI + Groq RAG; knowledge local/Supabase; Render deploy
