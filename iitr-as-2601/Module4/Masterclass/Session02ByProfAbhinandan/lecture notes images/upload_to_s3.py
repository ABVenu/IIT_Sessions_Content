"""Upload masterclass Session02ByProfAbhinandan lecture note images to S3."""
import os
...
PREFIX = "iitr-as-2601/module4/masterclass/session02byprofabhinandan"
...
urls = {}
for path in sorted(images_dir.glob("masterclass02-*.png")):
