...
The product name is **Nimbus PayDesk**. The walk is **build** this meeting, then **polish, demo, and submit** in the next one. Two meetings. Not three. Skipping the freeze is how teams “start coding” and finish with three products.
...
Upcoming work puts a **counter** on this desk, tells the story with traces, **and** packs a README so a stranger can replay G01–G03. That is one meeting. Do not decorate a graph that still waves HIGH through.
