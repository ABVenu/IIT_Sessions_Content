"""Upload Session01 Hands-On LangChain lecture note images to S3."""
import os
...
PREFIX = "iitr-as-2603/masterclass/session01-hands-on-langchain"
...
urls = {}
for path in sorted(images_dir.glob("session01-*.png")):
