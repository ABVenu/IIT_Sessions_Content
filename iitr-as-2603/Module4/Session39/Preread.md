...
In the previous session, you built **Agentic RAG** — agents that decide when and what to retrieve. That skill stays important. This session adds **new input types** so your agents are not limited to typed text alone.
