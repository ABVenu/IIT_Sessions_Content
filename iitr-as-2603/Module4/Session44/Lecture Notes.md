...
![Three messy failure modes at a campus help desk — endless spinning wait, temporary glitch retried successfully, and a permanently closed counter with a clear user message](https://s13n-curr-images-bucket.s3.ap-south-1.amazonaws.com/iitr-as-2603/module4/session44/session44-01-messy-failure-modes.png)
...
![Split comparison of transient network blip worth retrying versus permanent bad input that should fail fast with clear guidance](https://s13n-curr-images-bucket.s3.ap-south-1.amazonaws.com/iitr-as-2603/module4/session44/session44-02-transient-vs-permanent.png)
...
![Metro-style workflow showing per-node kitchen timers at each station versus one large clock limiting the entire journey from start to finish](https://s13n-curr-images-bucket.s3.ap-south-1.amazonaws.com/iitr-as-2603/module4/session44/session44-03-per-node-vs-global-timeout.png)
...
![Campus ticket counter retrying a flaky service with bounded attempts and growing pause gaps between tries until success on the third attempt](https://s13n-curr-images-bucket.s3.ap-south-1.amazonaws.com/iitr-as-2603/module4/session44/session44-04-retry-backoff-policy.png)
...
![Contrast between showing a scary technical stack trace to a student versus a calm professional help-desk message with clear next steps after retries are exhausted](https://s13n-curr-images-bucket.s3.ap-south-1.amazonaws.com/iitr-as-2603/module4/session44/session44-05-user-facing-error.png)
